...
const CATEGORIES = {
  appetizer:{key:"appetizer",emoji:"🐙",label:"Appetizers",subtitle:"Quick Movement",duration:5*60,color:"#C8A8E9",colorLight:"#EDE0F7",colorDark:"#9B6FCF",
    defaults:[{id:"a1",name:"Stretch & Shake",desc:"Streck dich wie ein Seestern 🌟"},{id:"a2",name:"Tanz-Break",desc:"30 Sek Lieblingslied tanzen 💃"},{id:"a3",name:"Kaltes Wasser",desc:"Hände unter kaltes 
Wasser & atmen 💧"},{id:"a4",name:"Hampelmann",desc:"20 Jumping Jacks! 🦘"},{id:"a5",name:"Fenster auf!",desc:"Frische Luft schnappen ☁️ "}]},
